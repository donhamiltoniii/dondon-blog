...
describe('food assets utilities', () => {
        ...
        it('should return only meal prep food assets', async () => {
            const mockAssets = [
                createMockFoodAsset(
                    'recipe1',
                    'Meal Prep Bowl',
                    'src/content/food/meal-prep/bowl.md'
                ),
                createMockFoodAsset(
                    'recipe2',
                    'Regular Recipe',
                    'src/content/food/dinners/pasta.md'
                ),
                createMockFoodAsset(
                    'recipe3',
                    'Meal Prep Salad',
                    'src/content/food/meal-prep/salad.md'
                ),
            ];
        ...
        it('should handle assets without filePath', async () => {
            const mockAssets = [
                ...
                createMockFoodAsset(
                    'recipe2',
                    'Meal Prep Recipe',
                    'src/content/food/meal-prep/recipe.md'
                ),
            ];
        ...
        it('should sort meal prep assets by title', async () => {
            const mockAssets = [
                createMockFoodAsset(
                    'recipe1',
                    'Zucchini Bowl',
                    'src/content/food/meal-prep/zucchini.md'
                ),
                createMockFoodAsset(
                    'recipe2',
                    'Apple Salad',
                    'src/content/food/meal-prep/apple.md'
                ),
            ];
        ...
        it('should group food assets by category', async () => {
            const mockAssets = [
                ...
                createMockFoodAsset(
                    'recipe2',
                    'Salad',
                    'src/content/food/appetizers/salad.md'
                ),
                createMockFoodAsset(
                    'recipe3',
                    'Steak',
                    'src/content/food/dinners/steak.md'
                ),
            ];
        ...
        it('should handle assets without filePath', async () => {
            const mockAssets = [
                ...
                createMockFoodAsset(
                    'recipe2',
                    'With Path',
                    'src/content/food/desserts/cake.md'
                ),
            ];
        ...
        it('should handle multiple assets in same category', async () => {
            const mockAssets = [
                ...
                createMockFoodAsset(
                    'recipe2',
                    'Pie',
                    'src/content/food/desserts/pie.md'
                ),
                createMockFoodAsset(
                    'recipe3',
                    'Cookies',
                    'src/content/food/desserts/cookies.md'
                ),
            ];
            ...
            expect(result.desserts.map((a) => a.data.title)).toEqual([
                'Cake',
                'Cookies',
                'Pie',
            ]);
        ...
        it('should handle malformed file paths', async () => {
            const mockAssets = [
                ...
                createMockFoodAsset(
                    'recipe2',
                    'Normal Path',
                    'src/content/food/dinners/normal.md'
                ),
            ];
    ...
    describe('getFoodAssetsByTag', () => {
        it('should return assets with specified tag', async () => {
            const mockAssets = [
                createMockFoodAsset('recipe1', 'Vegan Pasta', undefined, [
                    'vegan',
                    'italian',
                ]),
                createMockFoodAsset('recipe2', 'Beef Stew', undefined, ['meat']),
                createMockFoodAsset('recipe3', 'Vegan Salad', undefined, [
                    'vegan',
                    'healthy',
                ]),
            ];
        ...
        it('should be case-sensitive for tags', async () => {
            const mockAssets = [
                createMockFoodAsset('recipe1', 'Recipe', undefined, ['Vegan']),
            ];
    ...
    describe('getSortedRecipeSectionEntries', () => {
        ...
        it('should preserve array contents while sorting keys', async () => {
            const mockRecipes = {
                dinners: [
                    createMockFoodAsset('1', 'Pasta'),
                    createMockFoodAsset('2', 'Steak'),
                ],
        ...
        it('should handle categories with special characters', async () => {
            ...
            expect(result.map(([cat]) => cat)).toEqual([
                'comfort food',
                'meal-prep',
                'quick_meals',
            ]);
