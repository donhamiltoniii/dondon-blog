...
- [IN PROGRESS]: **[Surely You're Joking, Mr. Feynman!](https://en.wikipedia.org/wiki/Surely_You%27re_Joking,_Mr._Feynman!)** — Richard Feynman
  Short anecdotes; literal chapters on safe-cracking and lockpicking. An esoterica-and-mischief memoir wearing a physicist's coat.

- **[Ficciones / Labyrinths](https://en.wikipedia.org/wiki/Ficciones)** — Jorge Luis Borges
  Secret societies, invented encyclopedias, infinite libraries, codes, doubles. Stories are 4–8 pages. The bullseye for my sensibility, and the first one in my bag.

- **[Masters of Atlantis](https://en.wikipedia.org/wiki/Masters_of_Atlantis)** — Charles Portis
  A comic novel about a man handed a "secret" manuscript of the lost wisdom of Atlantis, who builds a whole occult society around it that slowly dwindles into absurdity. Secret societies and esoterica played as deadpan comedy — short, funny, and a real on-ramp.
...
- **[The Quest for Hermes Trismegistus](https://en.wikipedia.org/wiki/Gary_Lachman)** — Gary Lachman
  Accessible narrative history tracing the legendary figure of Hermes Trismegistus from ancient Egypt through the Renaissance to now. A good spine for the whole hermeticism interest — and the one already on its way to me.
...
- **[The Spy and the Traitor](https://en.wikipedia.org/wiki/The_Spy_and_the_Traitor)** — Ben Macintyre
  Real Cold War espionage that reads like a thriller.

- **[Invisible Cities / If on a winter's night a traveler](https://en.wikipedia.org/wiki/Invisible_Cities)** — Italo Calvino
  Playful, absurd, structurally tricky, short sections. Adjacent to Borges.

- **[The Illuminatus! Trilogy](https://en.wikipedia.org/wiki/The_Illuminatus!_Trilogy)** — Robert Anton Wilson
  Unhinged conspiracy comedy — masks, subversion, paranoia played for laughs.

- **[Tinker Tailor Soldier Spy](https://en.wikipedia.org/wiki/Tinker_Tailor_Soldier_Spy)** — John le Carré
  The literary spy novel — tradecraft, moles, masks. Slower burn; worth it.

- **[Cryptonomicon](https://en.wikipedia.org/wiki/Cryptonomicon)** — Neal Stephenson
  WWII codebreakers and modern hackers; cryptography as plot engine. Long but propulsive.
...
- **[Thinking in Systems](https://en.wikipedia.org/wiki/Thinking_In_Systems:_A_Primer)** — Donella Meadows
  How systems behave, and why they resist being changed.

- **[A Brief History of Time](https://en.wikipedia.org/wiki/A_Brief_History_of_Time)** — Stephen Hawking
  Cosmology made legible.

- **[The Order of Time](<https://en.wikipedia.org/wiki/The_Order_of_Time_(book)>)** — Carlo Rovelli
  A short, lyrical take on what time actually is.

- **[How to Solve It](https://en.wikipedia.org/wiki/How_to_Solve_It)** — George Pólya
  A classic on the craft of solving problems.

- **[The Structure of Scientific Revolutions](https://en.wikipedia.org/wiki/The_Structure_of_Scientific_Revolutions)** — Thomas Kuhn
  Where the idea of the "paradigm shift" comes from.

- **[Guns, Germs, and Steel](https://en.wikipedia.org/wiki/Guns,_Germs,_and_Steel)** — Jared Diamond
  A big-swing argument about why history unfolded the way it did.

- **[The Righteous Mind](https://en.wikipedia.org/wiki/The_Righteous_Mind)** — Jonathan Haidt
  Why people who disagree about morality are often both sincere.

- **[The Book of Why](https://en.wikipedia.org/wiki/The_Book_of_Why)** — Judea Pearl
  Causation versus correlation, done properly.

- **[Antifragile](<https://en.wikipedia.org/wiki/Antifragile_(book)>)** — Nassim Taleb
  On things that gain from disorder.

- **[Superintelligence](https://en.wikipedia.org/wiki/Superintelligence:_Paths,_Dangers,_Strategies)** — Nick Bostrom
  The case for taking machine superintelligence seriously.

- **[Thinking, Fast and Slow](https://en.wikipedia.org/wiki/Thinking,_Fast_and_Slow)** — Daniel Kahneman
  The two-systems model of the mind. Worth reading once the habit can carry it.

- **[Behave](https://en.wikipedia.org/wiki/Behave:_The_Biology_of_Humans_at_Our_Best_and_Worst)** — Robert Sapolsky
  A sprawling tour of why humans do what they do.

- **[The Mismeasure of Man](https://en.wikipedia.org/wiki/The_Mismeasure_of_Man)** — Stephen Jay Gould
  A critical history of attempts to rank human intelligence.
...
- **[The Secret Teachers of the Western World](https://en.wikipedia.org/wiki/Gary_Lachman)** — Gary Lachman
  Lachman's broad survey of the Western esoteric current — wider than the Hermes book. Optional, but a natural next step if his writing clicks for me.

- **[The Art of Problem Solving](https://artofproblemsolving.com/store/book/aops-vol1)** — Richard Rusczyk
  Genuinely a workbook — read it with a pencil, not in bed.
...
- **[The Codebreakers](https://en.wikipedia.org/wiki/The_Codebreakers)** — David Kahn
  The definitive cryptography history. Reference-grade brick — for when the habit is real.
